...
public class UploadServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request,
        ...
        try {
            ...
            String htmlPage = "<!DOCTYPE html>" + "<html><head><title>File " +
                  "Upload Form</title></head>" + "<body><h1>Upload file</h1>" + "<form method=\"POST\" action=\"upload\" " + "enctype=\"multipart/form-data\">" + "<input type=\"file\" name=\"fileName\"/><br/><br/>" + "Caption: <input type=\"text\" name=\"caption\"<br/><br/>" + "<br />" + "Date: <input type=\"date\" name=\"date\"<br/><br/>" + "<br />" + "<input type=\"submit\" value=\"Submit\"/>" + "</form>" + "</body></html>";
    ...
    protected void doPost(HttpServletRequest request,
                          HttpServletResponse response, boolean fromBrowser) {
        DataOutputStream out = response.getOutputStream();
        ...
        try {
            ...
            String fileName = untrimmedfileName.substring(1,
                  untrimmedfileName.length() - 1);
            ...
            OutputStream os =
                  new FileOutputStream(new File("images\\" + date + caption + fileName));
            os.write(file);
            ...
            out.writeBytes("HTTP/1.1 200 OK\r\n");
            out.writeBytes("Content-Type: text/html\r\n\r\n");
            out.writeBytes(topPart + getListing("C:\\tomcat\\webapps" +
                  "\\photogallery\\images") + bottomPart);
    ...
    private String getListing(String path) {
        ...
        for (int i = 0; i < sortedImages.size(); i++) {
            ...
            else dirList += "<li>" + sortedImages.get(i) + "</li>";
        }
        return dirList;
    }
